              ...
              <div class="card mb-4">
                <div class="card-body overview">
                  <ul class="achivements">
                    <h2 style="color: maroon; font-family: cursive; font-weight: bolder;">Comilla University</h2>
                  </ul>
                  <div class="wrapper about-user">
                    <h2 class="card-title mt-4 mb-3">About</h2>
                    <p>The total information of student is given below.</p>
                  </div>
                  <div class="info-links">
                    <a class="website">
                      <i class="icon-globe icon">Father Name:</i>
                      <span style="font-family: vernada; font-size: 15px;" >{{$student_profile->student_fathername}}</span>
                    </a>
                     <a class="website">
                      <i class="icon-globe icon">Mother Name:</i>
                      <span style="font-family: vernada; font-size: 15px;" >{{$student_profile->student_mothername}}</span>
                    </a>
                     <a class="website">
